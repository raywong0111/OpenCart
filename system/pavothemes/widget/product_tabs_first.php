...
class PtsWidgetProduct_tabs_first extends PtsWidgetPageBuilder {

		public $name = 'product_tabs_first';
		public $group = 'product';
		public $usemeneu = false;
		
		public static function getWidgetInfo(){
			return array('label' =>  ('Product Tabs first'), 'explain' => 'Dislay Tabs: Newest, Bestseller, Special, Featured', 'group' => 'product'  );
		}
