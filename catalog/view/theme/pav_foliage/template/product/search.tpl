...
<div class="container">
	<div class="row">
		...
		<div id="content" class="<?php echo $class; ?> col-sm-12 col-xs-12">
			...
			<div class="criteria bg-white">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 space-5">
				...
				<input type="button" value="<?php echo $button_search; ?>" id="button-search" class="btn btn-v2 space-top-20" />
			</div>
