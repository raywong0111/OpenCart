    	...
    	<div id="content" class="<?php echo $class; ?> col-sm-12 col-xs-12">
      		<?php if ($products) { ?>
				...
				<div class="paging space-top-70 clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-left"><?php echo $results; ?></div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right"><?php echo $pagination; ?></div>
				</div>
      		<?php } else { ?>
