		...
		<header id="header" class="header-v3">
			<div class="container">
				<div class="top-header">
					<div class="row">
						<div class="lang-cur col-lg-4 col-md-4 col-sm-5 col-xs-6">
							<div class="pull-left"><?php echo $language; ?></div>
							<div class="pull-left"><?php echo $currency; ?></div>
						</div>
						<div id="logo" class="col-lg-4 col-md-4 col-sm-2 col-xs-12 text-center">
							<?php if ($logo) { ?>
						...
						<div id="box-right" class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
							<div id="cart-top" class="pull-right">
								<?php echo $cart; ?>
							</div>
							<div class="login-logout pull-right hidden-sm hidden-xs">
								<ul class="clearfix">
									<?php if ($logged) { ?>
				...
				<div class="row main-header">
					<div id="group-menu" class="col-lg-9 col-md-9 col-sm-7 col-xs-5">
						<div class="bo-mainmenu">
							<?php  require( ThemeControlHelper::getLayoutPath( 'common/parts/mainmenu.tpl' ) );   ?>
						</div>
					</div>
					<div id="box-search" class="col-lg-3 col-md-3 col-sm-5 col-xs-7">
						<?php echo $search; ?>
					</div>
				</div>
			</div>
